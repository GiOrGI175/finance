...
const UpdateInputCategoty: React.FC<UpdateInputCategotyProps> = ({
  form,
  setForm,
}) => {
  const [state, setState] = useState<DropdownInputState>({
    showDropdown: false,
    selectedOption: form.budgetName || '',
  });
  ...
  const selectOption = (option: string) => {
    ...
    setForm((prevForm) => ({ ...prevForm, budgetName: option }));
  };
...
export default UpdateInputCategoty;
